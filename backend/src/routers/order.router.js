...
OrderModel.deleteMany({
  status: OrderStatus.NEW,         // Only pending orders
  createdAt: { $lt: cutoffDate }   // Older than 15 days
})
  .then(result => {
    console.log(`🗑️ Deleted ${result.deletedCount} pending orders older than 15 days`);
  })
  .catch(err => {
